...
parser.add_argument('--deit-scale', type=float, default=None, metavar='SCALE_LEARNING_RATE',
...
def main():
    ...
    if args.deit_scale:
        ...
        args.lr = args.lr * args.batch_size * args.world_size / args.deit_scale
    ...
    ################################################################## For Dali
        ...
        if args.dgpu:
            ...
            # pipe = create_dali_pipeline(external_render= eii_gpu, prefetch_queue_depth=1,
            #                         batch_size=args.batch_size,
