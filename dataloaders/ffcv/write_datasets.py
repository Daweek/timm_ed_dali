...
Section('cfg', 'arguments to give the writer').params(
    dataset=Param(And(str, OneOf(['cifar', 'imagenet','fdb'])), 'Which dataset to write', default='imagenet'),
...
if __name__ == '__main__':
    ...
    print(colored("Total experiment time: {} seconds, {:0>4} ".format(fina_experiment_time,str(timedelta(seconds=fina_experiment_time))),'white'))