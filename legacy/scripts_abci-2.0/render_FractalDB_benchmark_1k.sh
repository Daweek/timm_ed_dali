...
mpirun --bind-to socket -machinefile $SGE_JOB_HOSTLIST --use-hwthread-cpus -npernode 80 -np 80 python mpi_ifs_search_egl.py --ngpus-pernode 4 --category 1000 --save_dir /scratch/acc12930pb/fdb/fdb1k
...
# For GPU
mkdir /scratch/acc12930pb/fdb/fdb1k/fdb1k_egl
# For CPU
# mpirun --bind-to none -machinefile $SGE_JOB_HOSTLIST -npernode 1 -np 4 mkdir ${SSD}/fdb1k_cpu

echo "Start REDNERING to local ..."
# For GPU
mpirun --bind-to socket -machinefile $SGE_JOB_HOSTLIST --use-hwthread-cpus -npernode 80 -np 80 python mpi_gpu.py --image_res 362 --ngpus-pernode 4 --save_root /scratch/acc12930pb/fdb/fdb1k/fdb1k --load_root /scratch/acc12930pb/fdb/fdb1k/csv_rate0.2_category1000_points200000 
# For CPU
