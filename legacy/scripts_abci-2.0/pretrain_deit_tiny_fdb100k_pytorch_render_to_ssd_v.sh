...
#$ -l h_rt=25:00:00
#$ -j y
#$ -o output/$JOB_ID_pretrain_deit_tiny_pyto_fdb100k_rendertossd.out
...
# mpirun --bind-to none --use-hwthread-cpus -np 80 python mpi_cpu.py --save_root ${LOCALDIR}/fdb1k_cpu
mpirun --bind-to socket -machinefile $SGE_JOB_HOSTLIST --use-hwthread-cpus -npernode 50 -np 5000 python mpi_gpu.py --ngpus-pernode 4 --image_res 362 --save_root /beeond/fdb100k --load_root /beeond/csv_rate0.2_category100000_points200000 
# du -sh ${DATASET}
cd ../../
##################################
