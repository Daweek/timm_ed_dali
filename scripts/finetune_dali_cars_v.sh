...
#$ -l h_rt=01:00:00
#$ -j y
#$ -o output/$JOB_ID_finetune_dali_deit_tiny_cars.out
#$ -N finetune_dali_deit_tiny_cars
...
# 41317088_pret_deit_Dali_tiny_fdb21k_egl_lr1.0e-3_ep90_bs8192_ssd_searchCSV
...
echo "Copy and Untar..."
mpirun --display-map --display-allocation --bind-to none -machinefile $SGE_JOB_HOSTLIST -npernode 1 -np 2 time tar -xf /home/acc12930pb/working/datasets/${DATASET_NAME}.tar -C ${SSD}
readlink -f ${SSD}
